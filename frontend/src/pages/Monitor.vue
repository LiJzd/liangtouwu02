  ...
  <div class="pb-12 min-h-screen flex flex-col">
    ...
    <section class="relative w-full h-[120px] flex items-center justify-between overflow-hidden border-b border-emerald-200 bg-emerald-200/30 px-8 shrink-0">
      ...
      <div class="relative z-10 flex flex-col items-start mt-2">
        <span class="text-primary font-headline font-bold tracking-[0.4em] text-[10px] uppercase">VIDEO SURVEILLANCE</span>
        <h1 class="text-2xl md:text-3xl font-headline font-bold text-emerald-950 tracking-tight">实况视频监控中心</h1>
      </div>
    </section>

    <!-- Content wrap -->
    <div class="max-w-7xl mx-auto w-full space-y-8 px-6 pt-8 flex-1 flex flex-col min-h-0">
      <div class="flex flex-col lg:flex-row h-[calc(100vh-14rem)] min-h-[500px] gap-6 flex-1 w-full">
        <!-- 信号源列表 -->
        <div class="w-full lg:w-80 bg-white/90 backdrop-blur-md rounded-2xl border border-emerald-200 flex flex-col overflow-hidden shadow-sm shrink-0">
          <div class="p-5 border-b border-emerald-100 bg-surface-container-low">
            <h2 class="font-headline font-bold text-emerald-950 flex items-center uppercase tracking-widest text-xs">
        ...
        <!-- 视频播放器 -->
        <div class="flex-1 bg-inverse-surface rounded-2xl border border-emerald-900/50 overflow-hidden relative group shadow-2xl flex flex-col justify-center min-h-[400px]">
